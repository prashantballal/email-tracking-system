...
<table width="95%" border="1" align="center" style="background-image:url('theme/<?php
...
?></div>
  ...
  <tr>
      <center>
          <td height="38" colspan="3" bgcolor="black">
		<a style="margin-left:50px; color: white;"  href="HomePage.php?chk=chngthm">Change Theme</a>
		<a style="margin-left:50px; color: white;"  href="HomePage.php?chk=chngPass">Change Password</a>
		
		<a style="margin-left:50px; color: white;" href="HomePage.php?chk=vprofile">Edit Your Profile</a>
		
		<!--<a style="margin-left:50px; color: white;" href="HomePage.php?chk=updnews">UPDATE LATEST NEWS</a>-->
                
		<a style="margin-left:50px; float: right; color: white;" href="HomePage.php?chk=logout">
                    Sign Out&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
